...
import 'package:bmi_starting/utils/rounded_icon_button.dart';
        ...
        body: Column(
          children: [
            ...
            ReuseableButton(
              ...
              onPress: () {
                BmiCalBrain cal =
                    BmiCalBrain(height: value.toInt(), weight: weight);
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => ResultPage(
                              ...
                              longResult: cal.getInterpretation(),
                              shortResult: cal.getResult(),
                            )));
              },
            )
          ],
